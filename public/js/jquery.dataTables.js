...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Pokaż _START_ to _END_ of _TOTAL_ pozycji",
			 ...
			 *  @type string
			 *  @default Pokaż 0 to 0 of 0 pozycji
			 *
			 *  @dtopt Language
		 ...
		 *
		 * * `simple` - 'Wstecz' and 'Dalej' buttons only
		 * * 'simple_numbers` - 'Wstecz' and 'Dalej' buttons, plus page numbers
		 * * `full` - 'First', 'Wstecz', 'Dalej' and 'Last' buttons
		 * * `full_numbers` - 'First', 'Wstecz', 'Dalej' and 'Last' buttons, plus
		 *   page numbers
		 *  
